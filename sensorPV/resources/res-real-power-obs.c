...
EVENT_RESOURCE(res_real_power_obs,
               "title=\"Real Power Data\";rt=\"text/plain\";obs",
               res_get_handler,
               NULL,
               NULL,
               NULL,
...
static void res_event_handler(void) {
    ...
    LOG_INFO("Event triggered - Real Power Data - Timestamp: %02d-%02d-%04d %02d:%02d:%02d | Real PV: %d,%04d kW\n",
