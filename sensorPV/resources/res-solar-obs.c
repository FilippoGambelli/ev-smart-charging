...
static void res_event_handler(void) {
    ...
    LOG_INFO("Event triggered - Solar Data - Timestamp: %02d-%02d-%04d %02d:%02d:%02d | Gb: %d,%04d W/m2 | Gd: %d,%04d W/m2 | Gr: %d,%04d W/m2 | HSun: %d,%04d degree | T: %d,%04d Celsius | WS: %d,%04d m/s\n",
